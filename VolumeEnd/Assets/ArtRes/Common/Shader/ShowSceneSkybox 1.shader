Shader "Sixerrr/ShowSceneSkybox1"
{
    Properties
    {
    ...
    SubShader
    {
        Pass
        {
            ...
            real4 frag(v2f i) : SV_Target
            {
                ...
                result = cloud * noise + lerp(starts,bigStartsTex.r * noise * startsColorPaletteTex * max(0,sin(_Time.y)),bigStartsTex.r);
                result = cloud + lerp(starts,bigStartsTex.r * _BigStartsIntensity_R * noise * startsColorPaletteTex * max(0,sin(_Time.y)),bigStartsTex.r);
                // result = i.color.a;
                // result *= 0;
                // clip(0.1-i.color.a);
                return real4(i.color.aaa,1-i.color.a);
            }
            ENDHLSL
        }
    }
